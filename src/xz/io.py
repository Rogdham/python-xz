...
class IOAbstract(IOBase):
    ...
    def _write(self, data):  # pragma: no cover
    ...
    def _truncate(self, size):  # pragma: no cover
...
class IOCombiner(IOAbstract):
    ...
    def _truncate(self, size):
        start, fileobj = self._fileobjs[size, True]
        if start != size:
    ...
    def _create_fileobj(self):  # pragma: no cover
        """
